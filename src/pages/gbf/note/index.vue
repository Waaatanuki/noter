...
<template>
  <div>
    <el-card m-auto :body-style="{ padding: '10px' }">
      <template #header>
        <div text-start text-xl font-bold>
          天元 土摇滚solo
        </div>
      </template>
      ...
      <div flex gap-2>
        ...
        <div shrink-0 text-start>
          ...
          <div>
            ...
            <div class="content">
              一层追伤4ta(24)+银姐援护炮(1)+神盾3(6)+愚者偷跑(6)=37hit
            </div>
          </div>
          <div>
            <div class="title">
            ...
            <div class="content">
              主(4)+情毛(3)+神盾(2)+愚者(1)+cb(1)+银姐(1)=12次<br>
          ...
          <div>
            ...
            <div class="content">
              正常循环: [毛1→神盾3→愚者3] , hit试炼: [神盾3→愚者3]<br>
              ⚠️情毛没刷上梅花buff的时候只有34hit, 需要补2hit
            </div>
          </div>
          <div>
            <div class="title">
          ...
          <div>
            ...
            <div class="content">
              ...
              20左右补惨雾, 留技能和召唤进15, 打进15的回合主角G攒一个200奥(可选)
            </div>
          </div>
          <div>
            <div class="title">
            ...
            <div class="content">
              ...
              - 2000w奥义 泰坦 充能<br>
              - 2000w技伤 充能<br>
              - 10回弱体 巴布000 充能 惨雾 凯姆24(刷新)23 所有伤害技能 FC<br>
              - 200w*10 泰坦 主1 充能<br>
              - FC 大巴 FC 充能<br>
              - 泰坦大公 充能爆了<br>
            </div>
